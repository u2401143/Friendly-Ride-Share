...
import com.friendlyrideshare.activities.RegistrationActivity;
...
public class CarOwnerProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Car Owner Profile");
        ...
        bt_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                submitCarOwnerProfile();
            }
        });
        serverData();
    }
    ProgressDialog pd;
    public  void submitCarOwnerProfile()
    {
        pd= new ProgressDialog(CarOwnerProfileActivity.this);
        pd.setTitle("Please wait,Data is being submit...");
        pd.show();
        EndPointUrl apiService = RetrofitInstance.getRetrofitInstance().create(EndPointUrl.class);
        Call<ResponseData> call = apiService.carownerUpdateProfile(et_first_name.getText().toString(),et_last_name.getText().toString(),et_phone_no.getText().toString(),et_email.getText().toString(),et_password.getText().toString());
        call.enqueue(new Callback<ResponseData>() {
            @Override
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                pd.dismiss();
                if (response.body().status.equals("true")) {
                    Toast.makeText(CarOwnerProfileActivity.this, response.body().message, Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<ResponseData> call, Throwable t) {
                Toast.makeText(CarOwnerProfileActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                pd.dismiss();
            }
        });
    }
    ...
    public void serverData(){
        progressDialog = new ProgressDialog(CarOwnerProfileActivity.this);
        progressDialog.setMessage("Loading....");
        progressDialog.show();

        EndPointUrl service = RetrofitInstance.getRetrofitInstance().create(EndPointUrl.class);
        SharedPreferences sharedPreferences = getSharedPreferences(Utils.SHREF, Context.MODE_PRIVATE);
        Call<List<EditProfilePojo>> call = service.getCarOwnerProfile(sharedPreferences.getString("uname","-"));
        ...
        call.enqueue(new Callback<List<EditProfilePojo>>() {
            ...
            public void onResponse(Call<List<EditProfilePojo>> call, Response<List<EditProfilePojo>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(CarOwnerProfileActivity.this,"No data found",Toast.LENGTH_SHORT).show();
                }else {
            ...
            public void onFailure(Call<List<EditProfilePojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(CarOwnerProfileActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override

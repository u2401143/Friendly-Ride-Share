...
import com.friendlyrideshare.activities.tourists.adapters.MyRidesAdapters;
...
public class MyRidesActivity extends AppCompatActivity {
    ...
    public void serverData(){
        progressDialog = new ProgressDialog(MyRidesActivity.this);
        ...
        call.enqueue(new Callback<List<BookingHistoryData>>() {
            ...
            public void onResponse(Call<List<BookingHistoryData>> call, Response<List<BookingHistoryData>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(MyRidesActivity.this,"No data found",Toast.LENGTH_SHORT).show();
                }else {
                    //getAllCars = response.body();
                    list_view.setAdapter(new MyRidesAdapters(response.body(), MyRidesActivity.this));
                }
            }
            ...
            public void onFailure(Call<List<BookingHistoryData>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MyRidesActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override

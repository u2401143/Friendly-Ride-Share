...
public class CarOwnersListAdapter extends BaseAdapter {
    List<EditProfilePojo> getAllCarOwnersProfilePojos;
    Context cnt;
    public CarOwnersListAdapter(List<EditProfilePojo> ar, Context cnt)
    {
    ...
    public void block(String id){
        ...
        Call<ResponseData> call = service.blockCarOwner(id);
        call.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                if(response.body()==null){
                    ...
                    ((RegisterdCarOwnersActivity)cnt).refresh();
    ...
    public void active(String id){
        ...
        progressDialog.show();
        EndPointUrl service = RetrofitInstance.getRetrofitInstance().create(EndPointUrl.class);
        Call<ResponseData> call = service.activeCarOwner(id);
        call.enqueue(new Callback<ResponseData>() {
            @Override
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                progressDialog.dismiss();

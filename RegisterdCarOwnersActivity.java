...
public class RegisterdCarOwnersActivity extends AppCompatActivity {
    ListView list_view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registerd_owners);
        list_view = findViewById(R.id.list_view);
        getSupportActionBar().setTitle("Car Owner Details");
    ...
    public void serverData(){
        progressDialog = new ProgressDialog(RegisterdCarOwnersActivity.this);
        progressDialog.setMessage("Loading....");
        progressDialog.show();

        EndPointUrl service = RetrofitInstance.getRetrofitInstance().create(EndPointUrl.class);
        Call<List<EditProfilePojo>> call = service.getAllCarOwners();
        ...
        call.enqueue(new Callback<List<EditProfilePojo>>() {
            ...
            public void onResponse(Call<List<EditProfilePojo>> call, Response<List<EditProfilePojo>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(RegisterdCarOwnersActivity.this,"No data found",Toast.LENGTH_SHORT).show();
                }else {
                    //getAllCars = response.body();
                    list_view.setAdapter(new CarOwnersListAdapter(response.body(), RegisterdCarOwnersActivity.this));
                }
            }
            ...
            public void onFailure(Call<List<EditProfilePojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(RegisterdCarOwnersActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
